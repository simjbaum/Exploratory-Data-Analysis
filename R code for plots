...
legend("topright", col = c("black","red","blue"), lty= c(1,1,1), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3")) # interesting here that when yuo have two plots in one (plotting different data) you have to use the concatenate command
...
lines(data_sub$Time, data_sub$Sub_metering_2, col = "red")
lines(data_sub$Time, data_sub$Sub_metering_3, col = "blue")
legend("topright", col = c("black","red","blue"), lty= c(1,1,1), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), cex = 0.75, bty = "n") # interesting here that when yuo have two plots in one (plotting different data) you have to use the concatenate command
